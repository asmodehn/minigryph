...
from lib.slacker import Slacker
from lib.session import get_a_redis_connection
import lib.metrics.quote as quote_lib
from lib.money import Money
from lib.exchange.exchange_order import Order                                   #pyx file
from lib.exchange.consts import Consts                                          #pyx file
from lib.exchange.exceptions import CachedOrderbookFailure, ExchangeAPIFailureException, ExchangeAPIErrorException
...
class Exchange(object):
    ...
    def exchange_data(self, db):
        from lib.exchange.exchange_factory import make_exchange_data_from_key
